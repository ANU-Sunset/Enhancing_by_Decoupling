...
# python fid.py --path ../engn8536/Datasets/z_map/FID/celebA256x256x200 --fid ../engn8536/Datasets/z_map/FID/our_gen
...
if __name__ == '__main__':
    ...
    is_mean1, is_std1, _, mu1, sigma1 = is_fid_model.get_score_image_tensor(img_list_tensor1, n_split=10, return_stats=True)
